...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showResult() {
    ...
    pollHeader.innerHTML = "\n\t\t\t<div class=\"result__checks-block\">\n\t\t\t\t<img class=\"result__check\" src=\"img/icon/icon__check-circle.svg\" alt=\"\">\n\t\t\t\t<img class=\"result__check\" src=\"img/icon/icon__check-circle.svg\" alt=\"\">\n\t\t\t\t<img class=\"result__check\" src=\"img/icon/icon__check-circle.svg\" alt=\"\">\n\t\t\t</div>\n\t\t\t<p class=\"poll__bottom-text\">Just a moment... We are analyzing your answers and preparing personalized schemes for earning money online</p>\n\t\t";
    pollBody.innerHTML = "\n\t\t\t<div class=\"poll__tab poll__tab--small\">\n\t\t\t\t<h2 class=\"poll__heading\">Preparation of earning schemes, according to your skills</h2>\n\t\t\t\t<div class=\"result__item-list\">\n\t\t\t\t\t<div class=\"result__item\">\n\t\t\t\t\t\t<div class=\"result__line-container\">\n\t\t\t\t\t\t\t<div class=\"result__line result__line--animated\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"result__content\">\n\t\t\t\t\t\t\t<div class=\"result__text\">Analysis of answers</div>\n\t\t\t\t\t\t\t<span class=\"result__percent\"> <span></span>% </span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"result__item\">\n\t\t\t\t\t\t<div class=\"result__line-container\">\n\t\t\t\t\t\t\t<div class=\"result__line result__line--animated\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"result__content\">\n\t\t\t\t\t\t\t<div class=\"result__text\">Selection of schemes</div>\n\t\t\t\t\t\t\t<span class=\"result__percent\"> <span></span>% </span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"result__item\">\n\t\t\t\t\t\t<div class=\"result__line-container\">\n\t\t\t\t\t\t\t<div class=\"result__line result__line--animated\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"result__content\">\n\t\t\t\t\t\t\t<div class=\"result__text\">Compilation of a personal plan for earning money online</div>\n\t\t\t\t\t\t\t<span class=\"result__percent\"> <span></span>% </span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t";
